...
List<CategoryProductModel> menCategoryData = [
  CategoryProductModel(
    productImage:
        'https://images.bestsellerclothing.in/data/JJ/26-sep-2022/299443903_g0.jpg?width=1080&height=1355&mode=fill&fill=blur&format=auto',
...
List<CategoryProductModel> womenCategoryData = [
  CategoryProductModel(
    productImage:
        'https://ng.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/87/8585531/1.jpg?2804',
    productModel: '5,340 items',
    productName: 'Clothing',
  ),
  CategoryProductModel(
